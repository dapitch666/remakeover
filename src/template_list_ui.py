...
from src.ui_common import format_datetime_for_ui, normalise_filename, show_toast
...
def _show_import_dialog(device: Device, add_log) -> None:
    ...
    with col_save:
        if st.button(
            ...
            if len(saved) == 1:
                show_toast(_("Template {name} saved").format(name=saved[0]), ":material/task_alt:")
            elif len(saved) > 1:
                show_toast(
    ...
    with st.expander(_(":material/sync: Sync"), expanded=False):
        ...
        def _on_check_sync():
            ...
            if ok_check:
                ...
                show_toast(_("Sync status checked"), ":material/task_alt:")
            else:
                show_toast(_("Sync check error"), ":material/error:")
        ...
        def _on_sync_now():
            ...
            if _ok:
                ...
                show_toast(_("Templates synced"), ":material/task_alt:")
                ...
                show_toast(_("Sync error"), ":material/error:")
        ...
        def _on_reset_reinit():
            ...
            if _ok:
                ...
                show_toast(_("Error: {msg}").format(msg=_msg), ":material/error:")
